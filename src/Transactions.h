...
public:
  CollectiveTransaction(float m, int p, Person::Category c,
...
public:
  SpecificTransaction(float m, int p, Person::Category c,
                      std::vector<int> incl_ids, std::time_t t = std::time(0))
